...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public async Task SendStatistic()
        {
            ...
            var value8 = _productService.TProductNameBuyMaxPrice();
            await Clients.All.SendAsync("ReceiveProductNameBuyMaxPrice", value8);

            var value9 = _productService.TProductNameBuyMinPrice();
            await Clients.All.SendAsync("ReceiveProductNameBuyMinPrice", value9);
            ...
            //var value15 = _moneyCaseService.TMoneyCaseCount();
            //await Clients.All.SendAsync("ReceiveMoneyCaseCount", value15);
